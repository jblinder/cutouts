...
var LDAvis = function(to_select, data_or_file_name) {
    ...
    var K, // number of topics
        ...
        color1 = "#3F3F3F", // baseline color for default topic circles and overall term frequencies
        color2 = "#777777"; // 'highlight' color for selected topics and term-topic frequencies
    ...
    function visualize(data) {
        ...
        var chart = svg.append("g")
                .attr("transform", "translate(" + +(mdswidth + margin.left + termwidth+100) + "," + 2 * margin.top + ")")
                //.attr('x',400)
                .attr("id", barFreqsID);
        ...
        function term_on(term) {
            ...
            d3.selectAll(to_select + " .dot")
                ...
                .attr("r", function(d) {
                    //return (rScaleCond(d));
                    return (Math.sqrt(d*mdswidth*mdsheight*word_prop/Math.PI)+50);
                });
